...
<script src="<%=request.getContextPath()%>/AdminJsp/js/edit.js"
...
<body>
	<s:if test="Librarians==null">
		<s:action name="displayLibrarians" namespace="/" executeResult="true"></s:action>
	</s:if>
	<s:if test="Librarians!=null">
												...
												<tbody>
													<s:iterator value="Librarians">
														...
														<form name="form" action="editLibrarian" method="post">
															<tr>
																<td><input name="LibrarianID"
																	id="LibrarianID${LibrarianID}"
																	value=<s:property value="LibrarianID"/>
																	style="border: none;" readonly="readonly"></td>
																<td><input name="LibrarianName"
																	id="LibrarianName${LibrarianID}"
																	value="<s:property value="LibrarianName"/>"
																	style="border: none;" readonly="readonly"></td>
																<td><input type="email" name="Email"
																	id="Email${LibrarianID}"
																	value="<s:property value="Email"/>"
																	style="border: none;" readonly="readonly"></td>
																<td><input name="Password"
																	id="Password${LibrarianID}"
																	value="<s:property value="Password"/>"
																	style="border: none;" readonly="readonly"></td>
																<td>
																	<div>
																		<button id="edit${LibrarianID}" type="button"
																			value="edit"
																			class="caname${LibrarianID} btn btn-outline-success btn-icon-text btn-rounded btn-sm">edit
																		</button>
																		<div id="save${LibrarianID}" style="display: none;">
																			<button type="submit"
																				class="btn btn-outline-primary btn-icon-text btn-rounded btn-sm">save</button>
																			<input type="button" value="Delete"
																				class="btn btn-outline-danger btn-icon-text btn-rounded btn-sm"
																				onclick="form.action='deleteLibrarian';form.submit();">
																		</div>
																	</div>
																</td>
															</tr>
					...
					<footer class="footer">
						<div
							...
							<span
								...
								Â© 2018 <a href="https://www.templatewatch.com/" target="_blank">TTT</a>.
								All rights reserved.
							</span> <span
