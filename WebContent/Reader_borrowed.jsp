				...
				<div class="btn-group" role="group">
					<form action="search" class="form-inline my-2 my-lg-0">
						<input class="form-control mr-sm-2" type="text"
							name="searchContent" placeholder="Search by title or ISBN"
							aria-label="Search">
			...
			<div class="col-3 mt-8 ">
				<div class="nav flex-column nav-pills " id="v-pills-tab"
					...
					<a class="nav-link active" id="v-pills-Current-tab"
						...
						aria-controls="v-pills-Current" aria-selected="true">Current
						Borrowing</a> <a class="nav-link" id="v-pills-History-tab"
						data-toggle="pill" href="#v-pills-History" role="tab"
						aria-controls="v-pills-History" aria-selected="false">Borrowing
