...
this.template = function() {
    ...
    var templ = '<table cellpadding="0" cellpadding="0" class="ui-calendar-table">' + 
                    '<thead>' +
                        '<tr><th class="prev"><i></i></th><th colspan="5" class="switch"><span data-cal="year"></span>.<span data-cal="month"></span></th><th class="next"><i></i></th></tr>' +
    ...
    table.find('tfoot').append('<tr><td colspan="2"><span class="today">Today</span></td><td></td><td></td><td></td><td colspan="2"><span class="close">Close</span></td></tr>')
...
function template() {
    var templ = '<table cellpadding="0" cellpadding="0" class="datepicker">' + 
                    '<thead>' +
                        '<tr class="controls"><th colspan="7"><span class="prevMonth"><s></s></span><span class="currDate"><span class="currYs"></span>.<span class="currMo"></span>X</span></th></tr>' +
    ...
    table1 = Z(table1)
    table1.find('tfoot').find('td').append('<span class="today">Today</span>')
