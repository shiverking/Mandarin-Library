...
public class Mail3 {
	 ...
	 */
	public static MimeMessage getMimeMessage(Session session, String LibrarianName, String LibrarianPassword)
			throws Exception {
		// 创建一封邮件的实例对象
		...
		// 设置邮件主题
		msg.setSubject("Retrieve password message", "UTF-8");
		// 设置邮件正文
		msg.setContent("Dear " + LibrarianName + ":<br/> <pre><strong >	your password is </strong> <i>"
				+ LibrarianPassword + "</i></pre>"+ "<p style='text-align: right;'>——Mandarin Librarian</p>", "text/html;charset=GBK");
		// 设置邮件的发送时间,默认立即发送
