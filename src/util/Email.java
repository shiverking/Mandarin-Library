...
public class Email {
	...
	public static MimeMessage getMimeMessage(Session session, String readerName, String bookName) throws Exception {
		...
		// 设置邮件正文
		msg.setContent("Dear " + readerName + "："  + "<p><pre> 	The <strong style='text-align:center'>《"
				+ bookName + "》</strong > you have borrowed is about to expire."
				+ "Please return it to the library in time.</pre></p>"
				+ "<p style='text-align: right;'>——Mandarin Librarian</p>", "text/html;charset=UTF-8");
		// 设置邮件的发送时间,默认立即发送
